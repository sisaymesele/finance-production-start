# services/strategic_report_context.py
#view and excel
...
def get_strategic_report_context(request):
    ...
    if search_query:
        strategic_reports = strategic_reports.filter(
    ...
    monthly_strategic_report_aggregate = (
        strategic_reports
    ...
    return {
        ...
        'monthly_strategic_report': monthly_strategic_report,
        'monthly_strategic_report_aggregate': monthly_strategic_report_aggregate,
    }
